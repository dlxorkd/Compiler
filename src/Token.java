public class Token {
   ...
   public static final Token charTok = new Token(TokenType.String, "string");
   ...
   public static final Token yesInTok = new Token(TokenType.YesIn, "yesin"); // 11.09.3
   public static final Token yesOutTok = new Token(TokenType.YesOut, "yesout");
   public static final Token inTok = new Token(TokenType.In, "<-");
   public static final Token outTok = new Token(TokenType.Out, "->");
   public static final Token decreaseTok = new Token(TokenType.Decrease, "--");
   public static final Token increaseTok = new Token(TokenType.Increase, "++");
   public static final Token returnTok = new Token(TokenType.Return, "return");
   public static final Token remainderTok = new Token(TokenType.Remainder, "%");
